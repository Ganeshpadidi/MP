        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
                    <p class="text-xl text-white font-bold">Hari</p>
                    <p class="text-base text-gray-400 font-normal">Frontend Developer</p>
                    <p class="text-base leading-relaxed text-gray-500 font-normal">Hari plays the crucial role in developing the frontend of the inventory management system, he crafted and developed the frontend of the system</p>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
                    <p class="text-xl text-white font-bold">Arupya</p>
                    <p class="text-base text-gray-400 font-normal">Backend Developer</p>
                    <p class="text-base leading-relaxed text-gray-500 font-normal">Arupya plays the crucial role in developing the backend of the inventory management system, she crafted and developed the backend of the system</p>
                    <div class="flex justify-start space-x-2">
                        <a href="#" class="text-gray-500 hover:text-gray-600">
                            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
                    <p class="text-xl text-white font-bold">Lathifunnisa</p>
                    <p class="text-base text-gray-400 font-normal">Designer</p>
                    <p class="text-base leading-relaxed text-gray-500 font-normal">Lathifunnisa plays the crucial role in designing the inventory management system, she crafted and designed the frontend of the system</p>
                    <div class="flex justify-start space-x-2">
                        <a href="#" class="text-gray-500 hover:text-gray-600">
                            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
                    <p class="text-xl text-white font-bold">Ganesh</p>
                    <p class="text-base text-gray-400 font-normal">Tester</p>
                    <p class="text-base leading-relaxed text-gray-500 font-normal">Ganesh plays the crucial role in Testing the functionality of the inventory management system</p>
                    <div class="flex justify-start space-x-2">
                        <a href="#" class="text-gray-500 hover:text-gray-600">
                            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
